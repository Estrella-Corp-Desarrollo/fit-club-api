...
export interface ApiCategoryExerciseCategoryExercise
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_exercises';
  info: {
    description: '';
    displayName: 'Tipos de ejercicios';
    pluralName: 'category-exercises';
    singularName: 'category-exercise';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-exercise.category-exercise'
    > &
      Schema.Attribute.Private;
...
export interface ApiClubClub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coaches: Schema.Attribute.Relation<'oneToMany', 'admin::user'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDistanceDistance extends Struct.CollectionTypeSchema {
...
export interface ApiExerciseExercise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category_exercises: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-exercise.category-exercise'
    >;
...
export interface ApiGoalGoal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    goal_status: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGroupOfAthleteGroupOfAthlete
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::group-of-athlete.group-of-athlete'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPersonalBestPersonalBest
  extends Struct.CollectionTypeSchema {
...
export interface ApiPushSubscriptionPushSubscription
  ...
  info: {
    displayName: 'Suscripciones push';
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    entrenamientos: Schema.Attribute.Relation<
      'oneToMany',
      'api::workout.workout'
    >;
...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    distancia: Schema.Attribute.Relation<'oneToOne', 'api::distance.distance'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWorkoutTypeWorkoutType extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Tipo de entrenamientos';
    pluralName: 'workout-types';
    singularName: 'workout-type';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiWorkoutWorkout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    group_of_athletes: Schema.Attribute.Relation<
      'oneToOne',
      'api::group-of-athlete.group-of-athlete'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    workout_type: Schema.Attribute.Relation<
      'oneToOne',
      'api::workout-type.workout-type'
    >;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    personal_record: Schema.Attribute.Relation<
      'oneToMany',
      'api::personal-best.personal-best'
    >;
